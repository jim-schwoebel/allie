...
Allie is a framework for building machine learning models from audio, text, image, video, or .CSV files. Intended for both beginners and experts, Allie allows for quick prototyping of models and is easy-to-use and easy-to-extend to your desired modeling strategy.
