...
* [featurizing](https://github.com/jim-schwoebel/Allie/tree/master/features) - a list of audio, text, image, video, and csv featurization scripts (these can be specified in the settings.json files).  
