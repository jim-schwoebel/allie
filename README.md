...
* [Modeling](https://github.com/jim-schwoebel/Allie/tree/master/training) - for loading/storing machine learning models and making model predictions for files put in the load_dir. 
