...
if problemtype=='audio':
    # delete muliple speakers (audio), remove silence 
    os.system('python3 delete_multi_speaker.py %s %s'%(modelpath, folderpath))
    os.system('python3 remove_silence.py %s'%(folderpath))
