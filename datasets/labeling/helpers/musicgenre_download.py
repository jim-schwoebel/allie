...
option11=[one,two,three,four,five,six,seven,eight,nine,ten,eleven,twelve,thirteen,fourteen,fifteen,sixteen,seventeen,eighteen,nineteen,twenty,twentyone,twentytwo,twentythree,twentyfour,twentyfive,twentysix,twentyseven,twentyeight,twentynine,thirty]
for i in range(len(option11)):
    optionlist.append(option11[i])
...
option12=[one,two,three,four,five,six,seven,eight,nine,ten,eleven,twelve,thirteen,fourteen,fifteen,sixteen,seventeen,eighteen,nineteen,twenty,twentyone,twentytwo,twentythree,twentyfour,twentyfive,twentysix,twentyseven,twentyeight,twentynine,thirty]
for i in range(len(option12)):
    optionlist.append(option12[i])
...
option13=[one,two,three,four,five,six,seven,eight,nine,ten,eleven,twelve,thirteen,fourteen,fifteen,sixteen,seventeen,eighteen,nineteen,twenty,twentyone,twentytwo,twentythree,twentyfour,twentyfive,twentysix,twentyseven,twentyeight,twentynine,thirty]
for i in range(len(option13)):
    optionlist.append(option13[i])
...
option14=[one,two,three,four,five,six,seven,eight,nine,ten,eleven,twelve,thirteen,fourteen,fifteen,sixteen,seventeen,eighteen,nineteen,twenty,twentyone,twentytwo,twentythree,twentyfour,twentyfive,twentysix,twentyseven,twentyeight,twentynine,thirty]
for i in range(len(option14)):
    optionlist.append(option14[i])
...
option15=[one,two,three,four,five,six,seven,eight,nine,ten,eleven,twelve,thirteen,fourteen,fifteen,sixteen,seventeen,eighteen,nineteen,twenty,twentyone,twentytwo,twentythree,twentyfour,twentyfive,twentysix,twentyseven,twentyeight,twentynine,thirty]
for i in range(len(option15)):
    optionlist.append(option15[i]) 
...
option16=[one,two,three,four,five,six,seven,eight,nine,ten,eleven,twelve,thirteen,fourteen,fifteen,sixteen,seventeen,eighteen,nineteen,twenty,twentyone,twentytwo,twentythree,twentyfour,twentyfive,twentysix,twentyseven,twentyeight,twentynine,thirty]
for i in range(len(option16)):
    optionlist.append(option16[i])

#alternative
genreoptions=['alternative','classical','country','edm','jazz','rap','holiday','indie','christian','latin','newage','pop','reggae','rock','folk','soundtrack']
genres=[option1,option2,option3,option4,option5,option6,option7,option8,option9,option10,option11,option12,option13,option14,option15,option16]


for i in range(len(genreoptions)):

    #change back to base directory / reset urls 
    os.chdir('/Users/jim/Desktop/genres/')
    urls=list()

    for j in range(len(genres[i])):
        if j==0:       
            os.mkdir('/Users/jim/Desktop/genres/'+genreoptions[i])
            os.chdir('/Users/jim/Desktop/genres/'+genreoptions[i])
            
            for l in range(len(genres[i])):
                index=genres[i][l].find('https:')
                urls.append(genres[i][l][index:])

            for m in range(len(urls)):
                try:
                    print('getting %s'%(urls[m]))
                    video=pafy.new(urls[m])
                    ...
                    #new file with start and stop times 
                    file=filename+'.wav'
                    data,samplerate=sf.read(file)
                    totalframes=len(data)
                    totalseconds=totalframes/samplerate
                    #pick random 20 seconds for soundframe 
                    data, samplerate = sf.read(file)
                    totalframes=len(data)
                    ...
                    #snipped file rename and delete other files 
