...
| ------------- |-------------| -------------| -------------| 
| [combine_datasets.py](https://github.com/jim-schwoebel/allie/blob/master/train_dir/combine_datasets.py) | Combines multiple folders of featurized datasets into one folder for a two-class problem | ```python3 combine_datasets.py``` | ```python3 combine_datasets.py``` |
