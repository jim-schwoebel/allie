...
| [make_new.py](https://github.com/jim-schwoebel/allie/blob/master/train_dir/make_new.py) | Sample script to rename the URL / target column with a new directory; useful if you need to clone data from one hard disk to another (note you have to manually edit this script to make it useful). | ```python3 make_new.py``` | ```python3 make_new.py``` |
