...
| Setting | License | Accurate? | Quick? (<15 mins)| Good documentation? | Classification | Regression | Description |
| --------- |  --------- |  --------- | --------- | --------- | --------- | --------- |  --------- | 
...
| '[btb](https://github.com/HDI-Project/BTB)' | MIT License | ❌ | 4/5 | ❌ | ✅ | ✅  | Hyperparameter tuning with various ML algorithms in scikit-learn using genetic algorithms. |
| '[cvopt](https://github.com/genfifth/cvopt)' | BSD 2-Clause "Simplified" License|  5/5 | 4/5 | ❌ | ✅ | ✅  | Machine learning parameter search / feature selection module with visualization. |
| '[devol](https://github.com/joeddav/devol)' | MIT License |  5/5 | 4/5 | ❌ | ✅ | ✅  | Genetic programming keras cnn layers. |
...
| '[hungabunga](https://github.com/ypeleg/HungaBunga)' | MIT License | ❌ | 4/5 | ❌ | ✅ | ✅  | HungaBunga: Brute-Force all sklearn models with all parameters using .fit .predict! |
| '[hyperband](https://github.com/thuijskens/scikit-hyperband)' | BSD 3-Clause "New" or "Revised" License |  5/5 | 4/5 | ✅ | ✅ | ✅  | Implements a class HyperbandSearchCV that works exactly as GridSearchCV and RandomizedSearchCV from scikit-learn do, except that it runs the hyperband algorithm under the hood. |
| '[hypsklearn](https://github.com/hyperopt/hyperopt-sklearn)' | [BSD 3-Clause "New" or "Revised" License](https://github.com/hyperopt/hyperopt-sklearn/blob/master/LICENSE.txt) |  5/5 | 4/5 | ✅ | ✅ | ✅  | Hyperparameter optimization on scikit-learn models. |
| '[imbalance](https://pypi.org/project/imbalanced-learn/)' | MIT License |  5/5 | 4/5 | ✅ | ✅ | ✅  | Imbalance learn different ML techniques to work on data with different numbers of samples. |
| '[keras](https://keras.io/getting-started/faq/)' | MIT License |  5/5 | 4/5 | ✅ | ✅ | ✅  | Simple MLP network architecture (quick prototype - if works may want to use autoML settings). |
| '[ludwig](https://github.com/uber/ludwig)' | Apache 2.0 |  5/5 | 4/5 | ✅ | ✅ | ✅  | Deep learning (simple ludwig). - convert every feature to numerical data. |
| '[mlblocks](https://github.com/HDI-Project/MLBlocks)' | MIT License | ✅ | 4/5 | ❌ | ✅ | ✅  | Most recent framework @ MIT, regression and classification. |
...
| '[scsr](https://github.com/jim-schwoebel/voicebook/blob/master/chapter_4_modeling/train_audioregression.py)' | Apache 2.0 |  5/5 | 4/5 | ✅ | ❌ | ✅  | Simple classification / regression (built by Jim from NLX-model). |
